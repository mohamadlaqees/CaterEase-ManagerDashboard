      ...
      <div className="flex gap-5 flex-col 2xl:flex-row">
        ...
        <section className="basis-1/2 space-y-5">
          ...
          <div className="flex flex-col md:flex-row gap-10 justify-between">
            <div className="basis-1/2 flex items-center gap-5 p-5 border-2 border-gray-200 rounded-md">
          ...
          {/* Orders History Table Skeleton */}
          <div className="p-8 w-full border-2 border-gray-200 rounded-md">
                ...
                <table className="w-full min-w-[500px]">
                  ...
                  <thead>
                    <tr className="border-b border-gray-200">
                      {[...Array(4)].map((_, i) => (
                        <th key={i} className="py-2 px-2 text-left">
